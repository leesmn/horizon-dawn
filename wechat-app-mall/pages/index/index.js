  ...
  onLoad: function(e) {   
    ...
    WXAPI.banners({
      ...
      if (res.code == 700) {
        ...
        that.setData({
          banners: res.data.advertiseList,
          swiperMaxNumber: res.data.advertiseList.length,
          goodsRecommend: res.data.hotProductList
        });
      }
    }).catch(function(e) {
      wx.showToast({
    ...
    WXAPI.homeGoodsCategory(0).then(function(res) {
      // let categories = [{
      //   id: 0,
      //   icon: '/images/fl.png',
      //   name: "全部"
    ...
    // WXAPI.homeRecommendGoods().then(res => {
    //   if (res.code === 200){
    //     that.setData({
    //       goods: res.data
    //     })
