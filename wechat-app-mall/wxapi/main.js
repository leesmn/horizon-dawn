...
const API_BASE_URL = 'http://192.168.1.106:8085'
...
module.exports = {
  request,
  queryHomeContent: (data) => {
    return request('/home/content', false, 'get', data)
  },
  homeGoodsCategory: (cateId) => {
    return request('/home/productCateList/' + cateId, false, 'get')
  },
  goods: (data) => {
    return request('/home/recommendProductList', false, 'get', data)
  },
  goodsDetail: (productId) => {
    return request('/home/productDetail/' + productId, false, 'get')
  },
  login: (_code) => {
    return request('/sso/wxappLogin', false, 'post', {
      code: _code
    })
  },
  register: (data) => {
    return request('/sso/wxappRegister', false, 'post', data)
  },
  checkToken: (_token) => {
    return request('/sso/checkToken', false, 'get', {
      token: _token
    })
  },
  orderCreate: (data) => {
